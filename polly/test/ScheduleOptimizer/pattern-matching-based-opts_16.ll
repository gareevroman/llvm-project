...
; CHECK-NEXT:    for (int c1 = 0; c1 <= 10; c1 += 1) {
; CHECK-NEXT:      for (int c4 = 0; c4 <= 63; c4 += 1)
; CHECK-NEXT:        for (int c5 = 0; c5 <= 1023; c5 += 1)
; CHECK-NEXT:          for (int c6 = 6 * c1; c6 <= min(63, 6 * c1 + 5); c6 += 1)
; CHECK-NEXT:            CopyStmt_0(0, c1, c4, c5, c6);
; CHECK-NEXT:      for (int c2 = 0; c2 <= 15; c2 += 1) {
; CHECK-NEXT:        for (int c6 = 64 * c2; c6 <= 64 * c2 + 63; c6 += 1)
; CHECK-NEXT:          for (int c7 = 6 * c1; c7 <= min(63, 6 * c1 + 5); c7 += 1)
; CHECK-NEXT:            for (int c8 = 0; c8 <= 63; c8 += 1)
; CHECK-NEXT:              CopyStmt_1(0, c1, c2, c6, c7, c8);
; CHECK-NEXT:        // 1st level tiling - Points
; CHECK-NEXT:        // Register tiling - Tiles
; CHECK-NEXT:        for (int c3 = 0; c3 <= 255; c3 += 1)
; CHECK-NEXT:          for (int c4 = 0; c4 <= 15; c4 += 1)
; CHECK-NEXT:            for (int c5 = 0; c5 <= min(383, -384 * c1 + 4095); c5 += 1) {
; CHECK-NEXT:              // Loop Vectorizer Disabled
; CHECK-NEXT:              // Register tiling - Points
; CHECK-NEXT:              {
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4, 4 * c3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4, 4 * c3 + 1, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4, 4 * c3 + 2, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4, 4 * c3 + 3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 1, 4 * c3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 1, 4 * c3 + 1, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 1, 4 * c3 + 2, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 1, 4 * c3 + 3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 2, 4 * c3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 2, 4 * c3 + 1, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 2, 4 * c3 + 2, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 2, 4 * c3 + 3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 3, 4 * c3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 3, 4 * c3 + 1, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 3, 4 * c3 + 2, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:                Stmt_for_body9(64 * c2 + 4 * c4 + 3, 4 * c3 + 3, 6 * c1 + c5 / 64, c5 % 64);
; CHECK-NEXT:              }
; CHECK-NEXT:            }
; CHECK-NEXT:      }
; CHECK-NEXT:    }
